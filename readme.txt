...
pip install -r requirement.txt，安装所有必要的扩展。
python manager.py createall，创建所有相关的表，但是首先需要修改 config.py:SQLALCHEMY_DATABASE_URI
python manager.py runserver
访问 127.0.0.1:5000/login，提交你的文章，访问 127.0.0.1:5000/ 查看首页情况
更多信息
